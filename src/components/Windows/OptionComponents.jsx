            ...
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center">
                    <div className={`p-2 rounded-lg mr-3 transition-all duration-300 ${
                        editingOption ? 'bg-amber-100 text-amber-600' : 'bg-green-100 text-green-600'
                    }`}>
                        <Icon 
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            {editingOption ? 'Modifica los datos de la opción' : 'Complete los campos para crear una nueva opción'}
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                    {selectedSubmenusCount > 0 && (
                        <div className="flex items-center space-x-2 text-amber-600 bg-amber-50 px-3 py-1 rounded-full">
                            ...
                            <span className="text-sm font-medium">{selectedSubmenusCount} submenú{selectedSubmenusCount !== 1 ? 's' : ''}</span>
                        </div>
                    )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full border border-gray-300 rounded-lg px-4 py-3 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent hover:border-gray-400 appearance-none bg-white"
                                disabled={loading || isSubmitting}
                            >
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className={`w-full border rounded-lg px-4 py-3 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent ${
                                formErrors.opc_eje ? 'border-red-300 bg-red-50' : 'border-gray-300 hover:border-gray-400'
                            }`}
                            disabled={loading || isSubmitting}
                        />
                        {formErrors.opc_eje && (
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                            <span className={`text-sm px-3 py-1 rounded-full ${
                                ...
                                {selectedSubmenusCount} seleccionado{selectedSubmenusCount !== 1 ? 's' : ''}
                            </span>
                            {submenus.length > 6 && (
                                <button
                                    type="button"
                    ...
                    <div className={`border rounded-lg p-4 transition-all duration-300 ${
                        formErrors.submenu_ids ? 'border-red-300 bg-red-50' : 'border-gray-200 bg-gray-50'
                    }`}>
                        {submenus.length === 0 ? (
                            <div className="text-center py-8 text-gray-500">
                                <Icon name="AlertCircle" size={24} className="mx-auto mb-3 text-gray-300" />
                                <p className="text-sm font-medium">No hay submenús disponibles</p>
                            ...
                            <>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        {searchTerm && (
                                            <p className="text-xs text-gray-500 mt-2">
                                                Mostrando {filteredSubmenus.length} de {submenus.length} submenús
                                            </p>
                                        )}
                                    </div>
                                )}
                                ...
                                <div className={`space-y-3 transition-all duration-300 ${
                                    submenus.length > 6 && !expandedSubmenus ? 'max-h-72 overflow-hidden' : 'max-h-96 overflow-y-auto'
                                }`}>
                                    {filteredSubmenus.map((submenu, index) => (
                                        <div
                                            ...
                                            style={{ 
                                                ...
                                                animation: expandedSubmenus || index < 6 ? 'fadeInLeft 0.3s ease-out' : 'none'
                                            }}
                                        >
                                            <label
                                                ...
                                                <div className="flex items-start space-x-3">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <div className="flex items-center mb-2">
                                                            {submenu.ico_nombre && (
                                                                <Icon name={submenu.ico_nombre} size={14} className="mr-2 text-gray-500 flex-shrink-0" />
                                                            )}
                                                        ...
                                                        {submenu.menus && submenu.menus.length > 0 && (
                                                            <div className="flex flex-wrap gap-1">
                                                                <span className="text-xs text-gray-400 flex-shrink-0">Menús:</span>
